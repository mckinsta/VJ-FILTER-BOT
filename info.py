...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1489423238').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1489423238').split()]  # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002466099174').split()]  # For Multiple Id Use One Space Between Each.
...
kkchannel = environ.get('kkCHANNEL', '-1002172547878') # give your force subscribe channel id here else leave it blank
KKCHANNEL = int(kkchannel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request File With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002278330033')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None

# This Is Your Bot Support Group Id , Here Bot Will Not Give File Because This Is Support Group.
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002251771816')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://morekoushal:morekoushal@mck.x9r8o.mongodb.net/?retryWrites=true&w=majority&appName=MCK")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "MCK")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'MCK')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://https://t.me/+vz-07HOZgb1mNjA1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+uBepwzr-bo45NWM1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/G7jejwbw') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/AisMCK')
